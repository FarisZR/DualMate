...
import 'package:dualmate/schedule/service/rapla/rapla_several_months_response_parser.dart';
import 'package:dualmate/schedule/service/rapla/rapla_week_response_parser.dart';
...
class RaplaResponseParser {
  ScheduleQueryResult parseSchedule(String responseBody) {
    ...
    return ScheduleQueryResult(Schedule(), [
      ParseError(
        "Did not find a week_table and month_table class",
        StackTrace.current,
      ),
    ]);
  }
