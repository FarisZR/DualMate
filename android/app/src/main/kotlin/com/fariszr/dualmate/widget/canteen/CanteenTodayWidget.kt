...
class CanteenTodayWidget : AppWidgetProvider() {
    ...
    private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
        ...
        if (WidgetHelper(context).isWidgetEnabled()) {
            ...
            updateCanteenEntryList(context, views, appWidgetManager, appWidgetId, pendingIntent)
    ...
    private fun updateCanteenEntryList(
        ...
        views.setPendingIntentTemplate(R.id.canteen_entries_list_view, pendingIntent)
